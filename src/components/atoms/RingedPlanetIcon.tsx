...
/**
 * Ringed planet — the Wrapstodon brand glyph.
 *
 * Inlined rather than pulled from an icon package: lucide-react v1 removed its
 * brand glyphs, and this was the only reason the project still depended on
 * react-icons. Path data is unchanged from the original so it renders identically.
 */
export function RingedPlanetIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
