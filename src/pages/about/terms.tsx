...
export default function TermsOfServicePage() {
  ...
  return (
    <MainLayout>
      <Head><title>Terms of Service - Mastodon</title></Head>
      <Container>
        {/* Header */}
        <Header>
...
const TermsContent = styled.div`
  ...
  p { margin: 0 0 var(--size-4) 0; }
  h1 { font-size: var(--font-size-4); margin: var(--size-6) 0 var(--size-3); }
  h2 { font-size: var(--font-size-3); margin: var(--size-5) 0 var(--size-2); }
  h3 { font-size: var(--font-size-2); margin: var(--size-4) 0 var(--size-2); }
  ul, ol { margin: 0 0 var(--size-4) 0; padding-left: var(--size-5); }
  li { margin-bottom: var(--size-2); }
  a { color: var(--blue-6); text-decoration: none; &:hover { text-decoration: underline; } }
  strong { font-weight: 600; }
  hr { border: none; border-top: 1px solid var(--surface-3); margin: var(--size-6) 0; }
`;
